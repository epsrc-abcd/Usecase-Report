...
%	\tikzset{myshape/.style={draw, circle, minimum size = 0.5cm}}
	...
	\node[below = 0.25cm of Verify, minimum width = 2.4cm, minimum height = 1cm]	(Local)	{};
	\node[below = 0.1 of LocalC]										{\scriptsize Local Protocols};
	...
	% Typecheck
	\node[vertrec, left = 1.40cm of Local]			(Exec)					{};
	\node[above = 0 of Exec]												{\scriptsize Verified Code};
	\node[left = 1.75cm of Local]					(ExecC)					{\vdots};
	...
	\node[right = 1.1cm of Local]						(MonC)					{\vdots};
