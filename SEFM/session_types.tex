...
bottom of \figref{diagram} is developed
...
%\textbf{Maybe we can define better here!}
...
\dk{Here I would mention that local protocol can also be used as template for humans 
...
\dk{I should also add automatic code/API generation}
