...
\subsection{Session Types as a Software Development Method}%: The Scribble Tool-chain}
...
development process. \figref{diagram} illustrates the use of the Scribble tools. Rectangles
