...
The Jacobi and Monte Carlo simulation algorithms are classic parallel algorithms
...
%For example, the repository contains implementations of the Monte-Carlo $\pi$ simulation with two different patterns, scatter-gather and master-worker (the former uses collective operations and all processes are involved in the main calculation, whereas with the latter
%workers are coordinated by a central master process by P2P
%communication that does not perform the main calculation).
