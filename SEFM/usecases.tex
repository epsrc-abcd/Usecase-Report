...
(none session-based) server implementations. \cut{Monitoring ensures
correct communication behaviour with untrusted or erroneous
components.}
...
classic concurrency problems. Classic concurrency problems require correct coordination
...
unexpected termination and orphan messages. The repository includes correct implementations of classic
